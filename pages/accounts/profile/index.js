            ...
            <div className="mb-3 mt-5 lg-3">
              <div className="mb-3">
                ...
                <Form noValidate autoComplete='off' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Form.Group className='mb-5' controlId="input-profile-image">
                      <div style={{ display: 'flex', alignItems: 'center' }}>
                        <div className='pro-pic'>
                          <Image width={100} height={100} className='me-4' src={'/profile-pic.png'} alt='Profile Pic' />
                        </div>
                        <div className='upload-btn'>
                          <Button variant='' htmlFor='account-settings-upload-image'>
                    ...
                    <Form.Group controlId="input-dob">
                      <Controller
                        name='dob'
                        control={control}
                        rules={{ required: true }}
